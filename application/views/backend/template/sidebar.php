    ...
    <div id="wrapper">
        ...
        <ul
            ...
            <a
                ...
                <div class="sidebar-brand-text mx-3">GRANDEZZA.ID</div>
            </a>
            ...
            <li class="nav-item">
                <a href="<?php echo site_url('Produk');?>" class="nav-link">
                    <i class="fas fa-fw fa-head-side-mask"></i>
                    <span>Produk</span></a>
            </li>
            <!-- Nav Item - Tables -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('pesanan/pesanan_masuk');?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo base_url() ?>assets/sbadmin2/img/undraw_profile.svg">
                            </a>
